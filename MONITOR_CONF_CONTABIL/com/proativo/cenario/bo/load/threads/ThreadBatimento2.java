	...
	public void exec(ContDetVo ob) {	
		...
		if(	ob.getCentroCusto() != null && ob.getOrdemInterna() != null && ob.getDivisao() != null
				...
				if(ob.getEmpresaMktCode() == div.getMktCode()) {
					...
					case 20:	//20 - TDATA
						if (!ob.getDivisao().equals("29SP")) {
							erro = new ErroVo(ob.getId(),ob.getElement(),ob.getTecnologia(),0,0,ob.getTipoLancamento(),ob.getAccountCategory(),ob.getOpenItemId(),10);
							addToRejectList(erro, ob, erro.getErrorType(),"29SP","","");
						}
						ordemInterna = "D29"+div.getDivisao();
						if(!ob.getOrdemInterna().equals(ordemInterna)) {
							erro = new ErroVo(ob.getId(),ob.getElement(),ob.getTecnologia(),0,0,ob.getTipoLancamento(),ob.getAccountCategory(),ob.getOpenItemId(),11);
						...
						if(!ob.getCentroCusto().equals(centroCusto)) {
							erro = new ErroVo(ob.getId(),ob.getElement(),ob.getTecnologia(),0,0,ob.getTipoLancamento(),ob.getAccountCategory(),ob.getOpenItemId(),12);
			...
			if( ob.getCentroCusto() == null || ob.getCentroCusto().isEmpty() ) {
				erro = new ErroVo(ob.getId(),ob.getElement(),ob.getTecnologia(),0,0,ob.getTipoLancamento(),ob.getAccountCategory(),ob.getOpenItemId(),13);
				addToRejectList(erro, ob, erro.getErrorType(),"","","");
			}		
			if( ob.getOrdemInterna() == null || ob.getOrdemInterna().isEmpty() ) {
				erro = new ErroVo(ob.getId(),ob.getElement(),ob.getTecnologia(),0,0,ob.getTipoLancamento(),ob.getAccountCategory(),ob.getOpenItemId(),14);
				addToRejectList(erro, ob, erro.getErrorType(),"","","");
			}	
