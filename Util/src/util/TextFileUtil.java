...
public class TextFileUtil
{
    ...
    public static String getContents(File arquivo){
    	...
    	try{
    		...
    		System.out.println("Ocorreu um erro lendo o arquivo texto.");
    	}    	
    ...
    public static void setContents(String path, String content)
    {
        ...
        {
            System.out.println("Ocorreu um erro inesperado gravando o arquivo texto.");
        }
        finally
        {
            if (out != null)
    ...
    private static boolean createFile(String path)
    {
        ...
        {
            System.out.println("Ocorreu um criando o arquivo.");
        }
